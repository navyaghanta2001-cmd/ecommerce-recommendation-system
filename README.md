...
| -- cleaned/           (Cleaned master dataset, RFM tables, similarity matrix) |-- notebooks/              (01_data_cleaning, 02_eda, 03_sql_analysis, 04_ai_modules) |-- sql/                     (SQL scripts and SQLite database) |-- powerbi/                  (Power BI dashboard .pbix) |-- app/                       (Streamlit app + saved models .pkl) -- docs/images/ (Charts and dashboard exports)
